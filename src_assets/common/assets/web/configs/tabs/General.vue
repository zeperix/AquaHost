...
<template>
  <div id="general" class="config-page">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="sunshine_name" placeholder="AquaHost"
    ...
    <div id="server_cmd" class="mb-3 d-flex flex-column">
      ...
      <div class="form-text">
        <a href="https://github.com/zeperix/AquaHost/wiki/Server-Commands" target="_blank">{{ $t('_common.learn_more') }}</a>
      </div>
