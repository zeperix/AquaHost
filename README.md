...
AquaHost is a self-hosted desktop stream host for [Artemis(Moonlight Noir)](https://github.com/ClassicOldSong/moonlight-android). Offering low latency, native client resolution, cloud gaming server capabilities with support for AMD, Intel, and Nvidia GPUs for hardware encoding. Software encoding is also available. A web UI is provided to allow configuration and client pairing from your favorite web browser. Pair from the local server or any mobile device.
...
- [x] Clipboard sync
- [x] Commands for client connection/disconnection (checkout [Auto pause/resume games](https://github.com/zeperix/AquaHost/wiki/Auto-pause-resume-games))
- [x] Input only mode
...
AquaHost supports dual GPUs seamlessly.
...
>
> AquaHost and SudoVDA can handle HDR just fine like any other streaming solutions.
>
> If you have had good experience with HDR previously, you can safely ignore this section.
>
> If you're curious, read on, but don't blame AquaHost for poor HDR support.
...
## How to run multiple instances of AquaHost for multiple virtual displays

Follow the instructions in the [Wiki](https://github.com/zeperix/AquaHost/wiki/How-to-start-multiple-instances-of-AquaHost).

## FAQ
Moved to [WiKi](https://github.com/zeperix/AquaHost/wiki/FAQ)

## Stuttering Clinic
Here're some common causes and solutions for stutters: [WiKi](https://github.com/zeperix/AquaHost/wiki/Stuttering-Clinic).

## Device specific setups
- Pixel devices might not be able to use native resolution:
  - Change the device resolution to High: https://github.com/zeperix/AquaHost/issues/700
...
SudoVDA: Virtual Display Adapter Driver used in AquaHost
...
No real time chat support will ever be provided for AquaHost and Artemis. Including but not limited to:
...
[Releases](https://github.com/zeperix/AquaHost/releases)
...
Yes, I'm going away. [AquaHost](https://github.com/zeperix/AquaHost) and [Artemis(Moonlight Noir)](https://github.com/ClassicOldSong/moonlight-android) will no longer be compatible with OG Sunshine and OG Moonlight eventually, but they'll work even better with much more carefully designed features.
